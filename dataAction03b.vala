//valac --pkg gio-2.0 dataAction03b.vala
...
public class myObject:GLib.Object, dataface{
    ...
    public void withData( ref dataAction dat){
		print("Start Encode Decode..\n");       
		dat.as_double64( ref d1 );
        dat.as_int32( ref i1 );
        dat.as_string32( ref s1 );
        print("End Encode Decode..\n");
    }
...
public class dataAction: GLib.Object{
    ...
    public dataMode _mode;
    public dataMode mode {
        get { return _mode; }
        set { offset = 0; _mode = value; }
    }
 ...
 */
void main () {
    print("**** dataAction ... Sample 3b                ****\n");	
    print("* NOTE:                                         *\n");
    print("* Modified for in byte[] storage and retrival   *\n");
    print("*                                               *\n");
    print("*                                               *\n");
    print("*************************************************\n\n");
    ...
    print ("Object state is %g, %d, %s\n", o1.d1, o1.i1, o1.s1);
    dataAction undo2 = new dataAction( o1.dataSize() );
    undo2.mode = dataMode.SAVE;
    
    ///Encapsulated data write
	o1.withData( ref undo2 );
    	
    //User Edit - Object
    o1.s1 = "I want a new string";
    print ("changed s1 = %s\n", o1.s1);
    o1.prt();
    ...
    print ("Object state is %g, %d, %s\n", o1.d1, o1.i1, o1.s1);
    dataAction undo3 = new dataAction( o1.dataSize() );
    undo3.mode = dataMode.SAVE;
    
    ///Encapsulated data write
	o1.withData( ref undo3 );
    	
    //User Edit - Object    
    o1.i1 = 44;
    o1.s1 = "A thrid revision";
    print ("changed i1, s1 = %d, %s\n", o1.i1, o1.s1);
    o1.prt();
    
    
    ///Undo Last change
    ///Flip dataAction to write to object from data
    undo3.mode = dataMode.OPEN;
